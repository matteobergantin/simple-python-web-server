...
error_handlers = [
    (401, views.handle401),                                 # This is just a test, visit http://HOSTNAME:PORT/send401 to see the behaviour of this function
]
...
urlpatterns = [
    ...
    ("/send401", views.send401)                             # This will emulate a 401 error code, just to test error handling
]
